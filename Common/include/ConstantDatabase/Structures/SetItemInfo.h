...
VISITABLE_STRUCT(Common::ConstantDatabase::SetItemInfo, si_id, si_hair, si_face, si_upper, si_under, si_pants, si_arms, si_boots, si_acce_A, si_acce_B, si_acce_C);
